...
builder.Services.AddSingleton<IQueryEndpointHealthRegistry, QueryEndpointHealthRegistry>();
builder.Services.AddSingleton<IQueryEndpointSelector, RoundRobinQueryEndpointSelector>();
builder.Services.AddScoped<IQueryEndpointRouter, QueryEndpointRouter>();
